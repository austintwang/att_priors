...
if __name__ == "__main__":
    ...
    center_cut_size = None

    shap_dir = "/mnt/lab_data2/atwang/models/domain_adapt/dnase/deepshap/transfer_v5/"
    out_dir = "/mnt/lab_data2/atwang/models/domain_adapt/dnase/modisco/transfer_v5/"
    ...
    for i, i_ex in cell_types.items():
        for j, j_ex in cell_types.items():
            ...
            shap_scores_hdf5 = os.path.join(shap_dir, f"{i}_from_{j}_shap.h5")
